...
<table cellspacing="0" cellpadding="0" style="border: none!important;">
  <tr cellspacing="0" cellpadding="0" style="border: none!important;">
    <td style="border: none!important;"><p>Visual Studio Code is the cross-platform coding environment we use across both Stage 5 Computer Technology and Stage 6 Software Engineering. When we use GitHub Codespaces in the cloud, we are using a virtualised version of Visual Studio Code.</p>
    <p>This repository contains example profiles to improve your development experience, along with links to templates for the main language environments we use.</p></td>
...
- [JetBrains Mono - a typeface for developers](https://marketplace.visualstudio.com/items?itemName=NarasimaPandiyan.jetbrainsmono)
